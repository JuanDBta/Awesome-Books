...
**[Awsome Books]** is a library useful to add and remove books in a list using the local storage.  For now the info of a book includes Title and Author.
...
```sh
  cd my-folder
  git clone "https://github.com/JuanDBta/Awsome-Books.git"
```
### Usage
...
Also I have to mention my coding partners in Week 1 Module 2 who work hard with me to create this project:

- Gardimy Charles
gardimycharles889@gmail.com
